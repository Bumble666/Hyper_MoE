...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        #datasets = load_from_disk('/aifs4su/data/zhaohao/xsum')
        datasets = load_from_disk('/aifs4su/data/zhaohao/cnn_dailymail')
    ...
    #torch.save(model.state_dict()['decoder.block.11.layer.2.mlp.n_experts_embedding.weight'], 'decode.pkl')
    #exit()
