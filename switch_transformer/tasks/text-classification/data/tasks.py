...
class Squad(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/mnli')[split]
...
class SciTail(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/scitail')
...
class MRPC(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/mrpc')
...
class COLA(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/cola')[split]
...
class SST2(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/sst2')[split]
...
class YelpPolarity(AbstractTask):
    ...
    def load_dataset(self, split):
        print(split)
        return load_from_disk('/aifs4su/data/zhaohao/yelp')[split]
...
class STSB(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/stsb')[split]
...
class QQP(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/qqp')[split]
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/qnli')[split]
...
class RTE(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/rte')[split]
...
class SuperGLUEBoolQ(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/boolq')[split]
...
class SuperGLUECB(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/cb')[split]
...
class SuperGLUECOPA(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/copa')[split]
...
class SuperGLUEMultiRC(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/multirc')[split]
...
class SuperGLUEWIC(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/wic')[split]
...
class SuperGLUEWSCFixed(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/wicfixed')[split]
...
class SuperGLUERecord(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/record')[split]
